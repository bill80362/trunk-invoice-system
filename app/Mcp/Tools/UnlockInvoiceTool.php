...
class UnlockInvoiceTool extends Tool
{
    protected string $description = '解除鎖定請款單（將狀態從 confirmed 改回 draft 並清除確認時間）。需要 invoices:write ability。';
    ...
    public function handle(Request $request): Response
    {
        ...
        if (! $invoice->isConfirmed()) {
            return Response::error('請款單並非 confirmed 狀態，無需解除鎖定。');
        }
